...
import LetterModal from "Pages/User/Laporan/Components/LetterModal"
import LetterTextModal from "Pages/User/Laporan/Components/LetterTextModal"
...
const Sar = () => {
    ...
    const getReport = useCallback(() => {
        ...
        url.search = `?year=${year}&month=${month}&category=sar`
